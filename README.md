...
I am a BSc student in Computer Science, good in Algorithms, Data Structures, Object-Oriented Programming, and Problem Solving skills. Quick learner, self-motivated, and social. I hope to work in the Embedded Systems industry, and I hope to work in automotive companies as an Embedded Software Engineer.
...
- ⚡ **Fun fact**: I love Cars(🚗), Codeing(💻), Full Moon(🌝), Crescent Moon(🌙), Traveling(🌍), Grapes(🍇), and Photography(📷).
